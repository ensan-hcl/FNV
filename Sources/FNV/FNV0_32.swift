...
extension FNV {
    ...
    /// FNV-0 32bit class
    public class FNV0_32 {
        
        // MARK: - Enum, Const
        private var h: UInt32 = 0
...
extension FNV.FNV0_32 {
    ...
    static public func digest(_ array: [UInt8]) -> UInt32 {
        return Common.fnv1(array, offsetBasis: 0, prime: Common.prime32)
    }
...
extension FNV.FNV0_32 {
    ...
    public func update(_ array: [UInt8]) {
        h = Common.fnv1(array, offsetBasis: h, prime: Common.prime32)
    }
...
extension FNV.FNV0_32 {
    ...
    public func copy() -> FNV.FNV0_32 {
        var copied = FNV.FNV0_32.init()
        copied.h = self.h
        return copied
    }
