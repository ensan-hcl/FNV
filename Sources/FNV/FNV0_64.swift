...
extension FNV {
    ...
    /// FNV-0 64bit class
    public class FNV0_64 {
        
        // MARK: - Enum, Const
        private var h: UInt64 = 0
...
extension FNV.FNV0_64 {
    ...
    static public func digest<S: Sequence>(_ sequence: S) -> UInt64 where S.Element == UInt8 {
        return Common.fnv1(sequence, offsetBasis: 0, prime: Common.prime64)
    }
...
extension FNV.FNV0_64 {
    ...
    public func copy() -> FNV.FNV0_64 {
        var copied = FNV.FNV0_64.init()
        copied.h = self.h
        return copied
    }
